    ...
    ICategoryRepository categoryRepository) : Controller
{
        ...
        int page = 1)
    {
        ...
        resProducts = filtered switch
        {
            Filtered.PriceAsc => resProducts.OrderByDescending(product => product.Price),
            Filtered.PriceDesc => resProducts.OrderBy(product => product.Price),
            Filtered.TitleAsc => resProducts.OrderByDescending(product => product.Title),
            Filtered.TitleDesc => resProducts.OrderBy(product => product.Title),
            _ => resProducts
        };
